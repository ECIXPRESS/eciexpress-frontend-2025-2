        ...
        <div className="bg-white rounded-xl shadow-2xl overflow-hidden">
          <div className="h-full flex flex-col max-h-[85vh]">
            ...
            <div className="bg-gradient-to-r from-yellow-400 to-yellow-500 text-white p-4 flex-shrink-0">
              <div className="flex justify-between items-start mb-2">
                <div>
                  ...
                  <p className="text-sm text-yellow-100">{pedido.nombreCliente}</p>
                </div>
              </div>
              
              <div className="flex items-center justify-between mt-3 pt-3 border-t border-white/20">
                <span className="text-sm text-yellow-100">Total del Pedido</span>
            ...
            <div className="flex-grow overflow-y-auto p-4">
              ...
              <div className="mb-4">
                <h4 className="font-bold text-gray-900 text-sm mb-2 flex items-center">
                  <ChefHat className="w-4 h-4 mr-1.5 text-yellow-500" />
                  Productos Ordenados
                </h4>
                <div className="space-y-2">
                      ...
                      <div className="flex items-start justify-between">
                        <div className="flex-1 min-w-0">
                          <p className="font-medium text-sm text-gray-900">
                            <span className="text-yellow-500">{producto.cantidad}x</span> {producto.nombre}
                          </p>
                        ...
                        <span className="font-bold text-sm text-yellow-500 ml-2 flex-shrink-0">
