      ...
      <div className="flex items-center p-4 gap-4">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="text-sm text-gray-700">
            <span className="font-semibold text-blue-600">{pedido.productos.length} producto(s): </span>
        ...
        <div className="flex flex-col gap-2 flex-shrink-0">
          <button
            ...
            className="bg-white hover:bg-gray-50 text-blue-600 border-2 border-blue-500 py-2 px-4 rounded-lg text-sm font-semibold transition-all duration-200 flex items-center justify-center gap-2 min-w-[140px]"
          >
          ...
          {pedido.estado === 'preparacion' && (
            <button
              ...
              className="bg-blue-500 hover:bg-blue-600 text-white py-2 px-4 rounded-lg text-sm font-semibold transition-all duration-200 flex items-center justify-center gap-2 shadow-md hover:shadow-lg min-w-[140px]"
            >
