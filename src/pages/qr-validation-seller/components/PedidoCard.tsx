    ...
    <div className="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden flex flex-col h-full transition-all duration-200 hover:-translate-y-1 hover:shadow-lg">
      ...
      <div className="flex-1 flex flex-col gap-3 p-4">
        ...
        <div className="bg-gray-50 border border-gray-200 rounded-lg p-3 text-sm text-gray-700">
          <p className="font-semibold text-primary-600 mb-1">{pedido.productos.length} producto(s)</p>
        ...
        <div className="mt-auto grid grid-cols-2 gap-2">
          <button
            ...
            className="w-full bg-white border-2 border-primary-500 text-primary-600 hover:bg-primary-50 rounded-lg py-2.5 px-3 text-sm font-semibold transition-all duration-200 flex items-center justify-center gap-2"
          >
