...
export const ManualCodeModal = ({ isOpen, onClose, onSuccess, onBackToScanner, }) => {
    ...
    return (_jsxs("div", { className: `
      ...
      `, onClick: onClose, children: [_jsx("div", { className: `
        ...
        `, style: {
          ...
          `, style: { transitionDelay: isAnimating ? '200ms' : '0ms' }, "aria-label": "Cerrar", children: _jsx(X, { className: "w-5 h-5 group-hover:rotate-90 transition-transform duration-300" }) }), _jsxs("div", { className: "bg-white rounded-2xl shadow-2xl overflow-hidden", children: [_jsx("div", { className: "bg-white p-6 border-b border-gray-100", children: _jsxs("div", { className: "text-center", children: [_jsx("div", { className: "inline-flex items-center justify-center w-16 h-16 bg-yellow-50 rounded-full mb-3", children: _jsx(Hash, { className: "w-8 h-8 text-yellow-500" }) }), _jsx("h3", { className: "font-bold text-xl text-gray-900 mb-1", children: "Escanea el c\u00F3digo de validaci\u00F3n" }), _jsx("p", { className: "text-sm text-gray-500", children: "Ingresa el c\u00F3digo del usuario que retira el pedido" })] }) }), _jsx("div", { className: "relative bg-white aspect-square", children: _jsx("div", { className: "absolute inset-0 flex items-center justify-center p-8", children: _jsxs("div", { className: "w-full max-w-xs", children: [_jsx("div", { className: "text-center mb-6", children: _jsx("p", { className: "text-base font-semibold text-gray-700", children: "C\u00F3digo de validaci\u00F3n" }) }), _jsxs("div", { className: "mb-4", children: [_jsx("input", { type: "text", value: code.join(''), onChange: (e) => {
                    ...
                    `, maxLength: 9 }), _jsx("div", { className: "mt-3 text-center", children: _jsxs("span", { className: `text-sm font-medium transition-colors duration-200 ${isComplete ? 'text-green-600' : 'text-gray-500'}`, children: [code.filter(d => d).length, " / 9 caracteres"] }) })] }), error && (_jsx("div", { className: "mb-4 p-3 bg-red-50 border-l-4 border-red-500 rounded-lg animate-shake", children: _jsx("p", { className: "text-sm text-red-700 font-medium text-center", children: error }) })), isComplete && !error && (_jsxs("div", { className: "bg-gray-50 rounded-xl p-4 border border-gray-200 shadow-sm", children: [_jsx("p", { className: "text-xs font-semibold text-gray-600 mb-3", children: "Detalles de la entrega" }), _jsxs("div", { className: "space-y-2 text-sm", children: [_jsxs("div", { className: "flex justify-between items-center", children: [_jsx("span", { className: "text-gray-600", children: "C\u00F3digo:" }), _jsx("span", { className: "font-bold text-gray-900", children: code.join('') })] }), _jsxs("div", { className: "flex justify-between items-center", children: [_jsx("span", { className: "text-gray-600", children: "Monto:" }), _jsx("span", { className: "font-semibold text-green-600", children: "$ 10.500" })] }), _jsxs("div", { className: "flex justify-between items-center", children: [_jsx("span", { className: "text-gray-600", children: "Descripci\u00F3n:" }), _jsx("span", { className: "font-medium text-gray-900 text-right", children: "Combo hamburguesa" })] })] })] }))] }) }) }), _jsxs("div", { className: "p-6 bg-white", children: [_jsx("button", { onClick: handleValidate, disabled: !isComplete, className: `
              ...
              `, children: "Validar" }), _jsx("button", { onClick: handleBackToScanner, className: "w-full bg-white hover:bg-gray-50 text-gray-700 border-2 border-gray-200 py-3 px-4 rounded-xl font-semibold transition-all duration-200 flex items-center justify-center gap-2 hover:border-gray-300", children: "Volver" }), _jsx("p", { className: "text-xs text-gray-400 text-center mt-3", children: "El c\u00F3digo se encuentra en el comprobante del pedido" })] })] })] }), _jsx("style", { children: `
        @keyframes shake {
