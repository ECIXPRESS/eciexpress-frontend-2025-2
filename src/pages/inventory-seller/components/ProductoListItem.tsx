      ...
      <div className="flex items-center p-4 gap-4">
        ...
        <div className="flex flex-col gap-2 flex-shrink-0">
          <button
            ...
            className="bg-white hover:bg-gray-50 text-yellow-500 border-2 border-yellow-400 py-2 px-4 rounded-lg text-sm font-semibold transition-all duration-200 flex items-center justify-center gap-2 min-w-[130px]"
          >
          ...
          <button
            ...
            className="bg-yellow-400 hover:bg-yellow-500 text-white py-2 px-4 rounded-lg text-sm font-semibold transition-all duration-200 flex items-center justify-center gap-2 shadow-md hover:shadow-lg min-w-[130px]"
          >
