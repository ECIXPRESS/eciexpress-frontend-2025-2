      ...
      >
        ...
        <div className="bg-white rounded-xl shadow-2xl overflow-hidden">
          <div className="h-full flex flex-col max-h-[85vh]">
            {/* Header */}
            <div className="bg-gradient-to-r from-yellow-400 to-yellow-500 text-white p-4 flex-shrink-0">
              ...
              <div className="flex items-center justify-between mt-3 pt-3 border-t border-white/20">
                <span className="text-sm text-yellow-100">Precio de venta</span>
            ...
            <div className="flex-grow overflow-y-auto p-4">
              ...
              <div className="mb-4">
                <h4 className="font-bold text-gray-900 text-sm mb-2 flex items-center">
                  <Package className="w-4 h-4 mr-1.5 text-yellow-500" />
              ...
              {producto.descripcion && (
                <div className="mb-4">
                  <h4 className="font-bold text-gray-900 text-sm mb-2 flex items-center">
                    <Tag className="w-4 h-4 mr-1.5 text-yellow-500" />
                    Descripción
                  </h4>
              ...
              <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3">
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <p className="text-xs font-semibold text-yellow-800">Última actualización</p>
                </div>
            ...
            <div className="p-4 border-t border-gray-100 flex-shrink-0">
              <button
                ...
                className="w-full bg-yellow-400 hover:bg-yellow-500 text-white py-3 px-4 rounded-xl font-semibold transition-all duration-200 shadow-md hover:shadow-lg"
              >
                Editar Stock
              </button>
            </div>
