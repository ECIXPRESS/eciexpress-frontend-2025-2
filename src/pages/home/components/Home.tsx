        ...
        <div className="flex min-h-screen bg-[#F6F6F6]">
            <div className="flex-1 md:ml-20 p-4 sm:p-6 md:p-8">
                <div className="max-w-7xl mx-auto">
                    ...
                    {/* Banner - responsive */}
                    <div
                        className="rounded-2xl sm:rounded-3xl md:rounded-[32px] mb-6 sm:mb-8 relative overflow-hidden shadow-lg">
                        <img
                            src={bannerImage}
                    ...
                    <div className="mb-8 sm:mb-10">
                        ...
                        <div className="hidden md:flex justify-center gap-8 lg:gap-12 overflow-x-auto pb-4 -mx-4 px-4">
                            {stores.map((store) => (
                                ...
                                >
                                    <div
                                        className="w-20 h-20 lg:w-24 lg:h-24 bg-gray-300 rounded-full shadow-md group-hover:scale-105 transition-transform"></div>
                        ...
                        <div className="md:hidden overflow-x-auto pb-4 -mx-4 px-4">
                            <div className="flex gap-6 sm:gap-8 min-w-max">
                                {stores.map((store) => (
                                    ...
                                    >
                                        <div
                                            className="w-20 h-20 sm:w-24 sm:h-24 bg-gray-300 rounded-full shadow-md group-hover:scale-105 transition-transform"></div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
                            ...
                            >
                                ...
                                <div className="p-4 sm:p-6">
                                    <div className="flex items-start justify-between mb-3 sm:mb-4">
                                        ...
                                        <div
                                            className="flex items-center gap-1.5 sm:gap-2 bg-gray-50 px-2.5 sm:px-3 py-1.5 sm:py-2 rounded-xl ml-3 sm:ml-4 flex-shrink-0">
                        ...
                        {product.rating}
                                    ...
                                    <div
                                        className="flex items-center justify-between mt-4 sm:mt-5 pt-3 sm:pt-4 border-t border-gray-100">
                                        <div>
