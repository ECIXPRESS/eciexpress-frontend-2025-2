...
export const OrdersList = ({ query = '', status }) => {
    ...
    return (_jsxs(_Fragment, { children: [_jsx("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-6", children: filtered.map(o => (_jsx(OrderCard, { order: o, onDetails: () => setSelectedOrder(o) }, o.id))) }), _jsx(OrderDetailsDrawer, { order: selectedOrder, isOpen: !!selectedOrder, onClose: () => setSelectedOrder(null) })] }));
};
