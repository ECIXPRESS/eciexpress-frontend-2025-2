                ...
                <div className="flex flex-col h-full">
                    ...
                    {shouldShowExpanded && showBalance && (
                        <div className="px-4 py-4 mb-4">
                            <div
                                className="bg-gradient-to-br from-[#FDDF65] to-[#f5d74e] rounded-2xl p-4 shadow-lg relative overflow-hidden">
                                {/* Decoraciones de triángulos */}
                                <div className="absolute inset-0 opacity-10">
                                    <div
                                        className="absolute top-2 right-2 w-16 h-16 border-4 border-white transform rotate-45"></div>
                                    <div
                                        className="absolute bottom-2 right-8 w-8 h-8 border-2 border-white transform -rotate-12"></div>
                                </div>
